    ...
    # Check for Yearly Statistics.
        ...
        Y_chart4 = dcc.Graph(
            figure=px.pie(
                ...
                values="Advertising_Expenditure",
                names="Vehicle_Type",
                title="Total Advertisement Expenditure Share by Vehicle Type in the year {}".format(
                    input_year
                ),
            )
        )

        # TASK 2.6: Return the graphs for displaying yearly data.
        return [
